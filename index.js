...
var config = {
  me: 'itmepinkbathrom', // The authorized account with a list to retweet.
  myList: 'beef', // The list we want to retweet.
  regexFilter: '(elinabloom||allieegraham)', // Accept only tweets matching this regex pattern.
